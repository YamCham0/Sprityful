-- Lower Sprityful's enforced daily generation limit from seven to three.
-- Keep the historical table check unchanged: prior UTC-date rows can legally
-- retain their former counts, while this function strictly caps all new calls.
