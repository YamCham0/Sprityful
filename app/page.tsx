...
export default function Home() {
  return (
    <main>
      ...
      <section className="showcase shell" id="showcase"><div className="showcase-copy"><div className="eyebrow"><span /> Made for lively worlds</div><h2>One character.<br /><em>A whole new game.</em></h2><p>Preview an export-ready action sheet, then open the studio when you are ready to make your own.</p><a className="button button-dark" href="/studio">Start creating <ArrowIcon /></a></div><div className="showcase-window"><div className="window-bar"><span /><span /><span /><b>preview / nova-runner.png</b></div><div className="checker"><Image src={showcaseSpriteUrl} alt="Pixel art character action-sheet showcase" width={1792} height={896} /></div><div className="window-footer"><span>4 character poses</span><span>export-ready sheet</span></div></div></section>
